...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Dashboard — Payroxa" },
      { name: "twitter:description", content: "Payroxa dashboard: wallet balance, quick actions, spending analytics, and recent activity." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/4a2d8091-b211-42d3-844c-01b9f84185f3" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/4a2d8091-b211-42d3-844c-01b9f84185f3" },
    ],
    links: [
